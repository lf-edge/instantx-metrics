...
public final class HiveMQBindingsModule_ProvideScheduledExecutorServiceFactory
    ...
    public static HiveMQBindingsModule_ProvideScheduledExecutorServiceFactory create(HiveMQBindingsModule module) {
        return new HiveMQBindingsModule_ProvideScheduledExecutorServiceFactory(module);
    }
